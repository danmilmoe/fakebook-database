...
SELECT u.user_id, u.first_name, u.last_name, u.year_of_birth, u.month_of_birth, u.day_of_birth, u.gender,
       ...
       p.institution AS institution_name, e.program_year AS program_year, p.concentration AS program_concentration, p.degree AS program_degree
FROM Users u
...
SELECT ue.event_id, ue.event_creator_id, ue.event_name, ue.event_tagline, ue.event_description, ue.event_host, ue.event_type, ue.event_subtype, ue.event_address, c.city_name AS event_city, c.state_name AS event_state, c.country_name AS event_country, ue.event_start_time, ue.event_end_time
FROM User_Events ue
